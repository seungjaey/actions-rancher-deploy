...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getServiceState = exports.getService = void 0;
const getService = (httpClient, serviceId) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield httpClient.get(`/services/${serviceId}`);
    return data;
});
exports.getService = getService;
const getServiceState = (httpClient, serviceId) => __awaiter(void 0, void 0, void 0, function* () {
    const service = yield (0, exports.getService)(httpClient, serviceId);
...
const getServices = (httpClient, { stackId, name }) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield httpClient.get('/services', {
        params: {
            name,
            stackId,
        },
...
const getStacks = (httpClient, stackName) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield httpClient.get('/stacks', {
        params: {
            name: stackName,
        },
    });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.postServiceFinishUpgrade = void 0;
const postServiceFinishUpgrade = (httpClient, serviceId) => __awaiter(void 0, void 0, void 0, function* () {
    yield httpClient.post(`/service/${serviceId}?action=finishupgrade`);
});
exports.postServiceFinishUpgrade = postServiceFinishUpgrade;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.postServiceUpgrade = void 0;
// TODO: add Option.actionState or Option.state
// TODO: extract actionState as constants
const postServiceUpgrade = (httpClient, { serviceId, launchConfig }) => __awaiter(void 0, void 0, void 0, function* () {
    yield httpClient.post(`/service/${serviceId}?action=upgrade`, {
        inServiceStrategy: {
            launchConfig,
        },
    });
});
exports.postServiceUpgrade = postServiceUpgrade;
...
const getHttpClient = ({ rancherHost, projectId, username, password }) => {
...
const http_client_1 = __nccwpck_require__(18);
const getStacks_1 = __nccwpck_require__(6683);
const getServices_1 = __nccwpck_require__(6579);
const postServiceUpgrade_1 = __nccwpck_require__(4964);
const postServiceFinishUpgrade_1 = __nccwpck_require__(307);
const getService_1 = __nccwpck_require__(7369);
const waitUntilServiceState_1 = __nccwpck_require__(2387);
const checkResource = (resource) => (0, core_1.some)(Boolean, [resource, (0, core_1.isEmpty)(resource)]);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const httpClient = (0, http_client_1.getHttpClient)({
            rancherHost: RANCHER_URL,
            projectId: PROJECT_ID,
            username: RANCHER_ACCESS,
            password: RANCHER_KEY,
        });
        const stack = yield (0, getStacks_1.getStacks)(httpClient, STACK_NAME);
        if (!checkResource(stack)) {
            throw new Error(`Cannot find ${STACK_NAME}`);
        }
        const firstStack = (0, core_1.head)(stack.data);
        if ((0, core_1.isUndefined)(firstStack)) {
        ...
        const firstService = (0, core_1.head)(services.data);
        if ((0, core_1.isUndefined)(firstService)) {
            throw new Error('Cannot find service');
        }
        const { id: serviceId, launchConfig } = firstService;
        const nextLaunchConfig = Object.assign(Object.assign({}, launchConfig), { imageUuid: `docker:${DOCKER_IMAGE}` });
        const currentState = yield (0, getService_1.getServiceState)(httpClient, serviceId);
        if (currentState === 'upgraded') {
            yield (0, postServiceFinishUpgrade_1.postServiceFinishUpgrade)(httpClient, serviceId);
            yield (0, waitUntilServiceState_1.waitUntilServiceState)(httpClient, { serviceId, targetState: 'active' });
        }
        yield (0, postServiceUpgrade_1.postServiceUpgrade)(httpClient, { serviceId, launchConfig: nextLaunchConfig });
        yield (0, waitUntilServiceState_1.waitUntilServiceState)(httpClient, { serviceId, targetState: 'upgraded' });
        yield (0, postServiceFinishUpgrade_1.postServiceFinishUpgrade)(httpClient, serviceId);
        yield (0, waitUntilServiceState_1.waitUntilServiceState)(httpClient, { serviceId, targetState: 'active' });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.waitUntilServiceState = void 0;
const core_1 = __nccwpck_require__(4414);
const constants_1 = __nccwpck_require__(7306);
const getService_1 = __nccwpck_require__(7369);
const pollingServiceState = (i, fetchFn) => __awaiter(void 0, void 0, void 0, function* () {
...
function asyncSequential(size, iterable) {
    return tslib_1.__asyncGenerator(this, arguments, function asyncSequential_1() {
        var i, items, _a, iterable_1, iterable_1_1, item, e_1_1;
        var _b, e_1, _c, _d;
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    if (!(iterable_1_1 = _e.sent(), _b = iterable_1_1.done, !_b)) return [3 /*break*/, 10];
                ...
                case 12:
                    ...
                    if (!(!_a && !_b && (_c = iterable_1.return))) return [3 /*break*/, 14];
                ...
                case 17:
                    if (!items.length) return [3 /*break*/, 20];
                    return [4 /*yield*/, tslib_1.__await(items)];
    ...
    return tslib_1.__asyncGenerator(this, arguments, function asyncSequential_1() {
        ...
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    if (!(iterable_2_1 = _f.sent(), _c = iterable_2_1.done, !_c)) return [3 /*break*/, 9];
                ...
                case 11:
                    ...
                    if (!(!_a && !_c && (_d = iterable_2.return))) return [3 /*break*/, 13];
                ...
                case 16:
                    if (!arr.length) return [3 /*break*/, 26];
                    _f.label = 17;
                case 17:
                    _f.trys.push([17, 23, 24, 25]);
                    arr_2 = (e_4 = void 0, tslib_1.__values(arr)), arr_2_1 = arr_2.next();
                    _f.label = 18;
                case 18:
                    if (!!arr_2_1.done) return [3 /*break*/, 22];
                    a = arr_2_1.value;
                    return [4 /*yield*/, tslib_1.__await(a)];
    ...
    return tslib_1.__asyncGenerator(this, arguments, function asyncSequential_1() {
        ...
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    if (!(iterableIterator_2_1 = _f.sent(), _c = iterableIterator_2_1.done, !_c)) return [3 /*break*/, 11];
                ...
                case 5:
                    ...
                    return [5 /*yield**/, tslib_1.__values(tslib_1.__asyncDelegator(tslib_1.__asyncValues(iterableIterator)))];
                case 6: return [4 /*yield*/, tslib_1.__await.apply(void 0, [_f.sent()])];
                case 7:
                    _f.sent();
                    _f.label = 8;
                ...
                case 13:
                    ...
                    if (!(!_a && !_c && (_d = iterableIterator_2.return))) return [3 /*break*/, 15];
        ...
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    _f.label = 1;
                case 1:
                    _f.trys.push([1, 13, 14, 19]);
                    _a = true, iterableIterator_2 = tslib_1.__asyncValues(iterableIterator);
                    _f.label = 2;
                case 2: return [4 /*yield*/, tslib_1.__await(iterableIterator_2.next())];
                case 3:
                    if (!(iterableIterator_2_1 = _f.sent(), _c = iterableIterator_2_1.done, !_c)) return [3 /*break*/, 12];
                    _e = iterableIterator_2_1.value;
                    _a = false;
                    _f.label = 4;
                case 4:
                ...
                case 7:
                    _f.sent();
                    return [5 /*yield**/, tslib_1.__values(tslib_1.__asyncDelegator(tslib_1.__asyncValues(iterableIterator)))];
                case 8: return [4 /*yield*/, tslib_1.__await.apply(void 0, [_f.sent()])];
                case 9:
                    _f.sent();
                    return [3 /*break*/, 11];
                case 10:
                ...
                case 14:
                    ...
                    if (!(!_a && !_c && (_d = iterableIterator_2.return))) return [3 /*break*/, 16];
                    return [4 /*yield*/, tslib_1.__await(_d.call(iterableIterator_2))];
                case 15:
                    _f.sent();
                    _f.label = 16;
    ...
    return tslib_1.__asyncGenerator(this, arguments, function asyncSequential_1() {
        ...
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2: return [4 /*yield*/, tslib_1.__await(iterable_2.next())];
                case 3:
                    if (!(iterable_2_1 = _e.sent(), _b = iterable_2_1.done, !_b)) return [3 /*break*/, 10];
                    _d = iterable_2_1.value;
                    _a = false;
                    _e.label = 4;
                case 4:
                    _e.trys.push([4, , 8, 9]);
                    item = _d;
                    if (!(i >= start && i < end)) return [3 /*break*/, 7];
                    return [4 /*yield*/, tslib_1.__await(item)];
                case 5: return [4 /*yield*/, _e.sent()];
                case 6:
                    _e.sent();
                ...
                case 12:
                    _e.trys.push([12, , 15, 16]);
                    if (!(!_a && !_b && (_c = iterable_2.return))) return [3 /*break*/, 14];
                    return [4 /*yield*/, tslib_1.__await(_c.call(iterable_2))];
                case 13:
                    _e.sent();
                    _e.label = 14;
    ...
    return tslib_1.__asyncGenerator(this, arguments, function asyncSequential_1() {
        ...
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 7:
                    if (!(iterable_2_1 = _e.sent(), _b = iterable_2_1.done, !_b)) return [3 /*break*/, 15];
                    _d = iterable_2_1.value;
                    _a = false;
                    _e.label = 8;
                case 8:
                ...
                case 17:
                    ...
                    if (!(!_a && !_b && (_c = iterable_2.return))) return [3 /*break*/, 19];
                    return [4 /*yield*/, tslib_1.__await(_c.call(iterable_2))];
                case 18:
                    _e.sent();
                    _e.label = 19;
                ...
                case 24:
                    ...
                    return [3 /*break*/, 28];
                case 25:
                    if (!(acc.length > 0)) return [3 /*break*/, 28];
                    return [4 /*yield*/, tslib_1.__await(acc)];
                case 26: return [4 /*yield*/, _e.sent()];
                case 27:
                    _e.sent();
                    _e.label = 28;
        ...
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    item = _d;
                    value = f(item);
                    if (!(0, utils_1.isPromise)(value)) return [3 /*break*/, 5];
                    return [4 /*yield*/, value];
                case 4:
                    _e.sent();
                    _e.label = 5;
...
var memoize_1 = tslib_1.__importDefault(__nccwpck_require__(1072));
...
var prop_1 = tslib_1.__importDefault(__nccwpck_require__(7108));
exports.prop = prop_1.default;
var props_1 = tslib_1.__importDefault(__nccwpck_require__(8283));
...
var unicodeToArray_1 = tslib_1.__importDefault(__nccwpck_require__(7606));
...
function memoize(f, resolver) {
    var memoized = function () {
        ...
        var key = typeof resolver === "function" ? resolver.apply(void 0, tslib_1.__spreadArray([], tslib_1.__read(args), false)) : args[0];
        var _self = memoized;
        ...
        var result = f.apply(void 0, tslib_1.__spreadArray([], tslib_1.__read(args), false));
...
function prop(key, obj) {
    if (obj === null)
        return undefined;
    if (obj === undefined)
        return function (obj) { return prop(key, obj); };
    return obj[key];
}
